...
@section('content')
    <section class="hero  is-large  is-bold is-primary">
        <div class="hero-body" style="
            background: url({{ asset("img/HBO-ICT-Software-Engineer-1920x600.jpg") }}) no-repeat center center;
        ...
        <div class="container">
            <div class="columns">
                ...
                <div class="column is-8-desktop is-12-tablet">
                    ...
                    <div class="content">
                        <h1>Welcome to the HZ Group Log Application</h1>
                        <div class="tile is-ancestor">
                            ...
                            <div class="tile is-parent">
                                <article class="tile is-child notification is-success">
                                    ...
                                    <p class="subtitle">{{ $groupCount }}</p>
                                </article>
                            </div>
                            <div class="tile is-parent">
                                <article class="tile is-child notification is-info">
                                    <p class="title">Comments</p>
                                    <p class="subtitle">162</p>
                                </article>
                            </div>
                        </div>
                        <p>
                ...
                <div class="column is-4-desktop is-12-tablet">
                    <p class="title is-4">Latest comments</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="has-text-centered">
                                            <a href="/posts/{{$post->title}}" class="button is-primary">Read more...</a>
                                        </div>
                                    </div>
