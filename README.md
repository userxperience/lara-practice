...
an application that is designed for HZ lecturers who need to keep track of student groups and share information about 
sprint retrospectives and other important events.

## Features

What's all the bells and whistles this project can perform?
* Manage Students, groups, projects and retros
* Add comment about groups
